          ...
          for (var result in results) {
            ...
            Marker marker = Marker(
              ...
              onTap: () {
                ...
                setState(() {
                  polylineCoordinates.clear();
                  _createPolylines(_startAddress as double, _destinationAddress as double,currentLocation as double,currentLocation as double);
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      // Fetch new fuel stations

                                      if (_destinationAddress.isNotEmpty) {
                                        // Convert the destination address to LatLng
                                        final destination = await _getLatLngFromAddress(_currentAddress);
